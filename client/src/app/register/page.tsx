              ...
              <form onSubmit={submitHandler} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      className="w-full pl-4 pr-12 py-2.5 bg-background border border-card-border rounded-xl text-white placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-primary-indigo transition-all duration-200"
                      id="password"
